...
generated_muon_kinematic_vectors = muGAN.generate_enhanced_from_seed_kinematics_EVO_ALGO_SMEAR(size=5000, seed_vectors=kinematics_of_muons, aux_multiplication_factor=1)[0]
...
muGAN.plot_p_pt(data=generated_muon_kinematic_vectors, filename='generated_muon_p_pt_vectors.png')

muGAN.plot_kinematics(data=generated_muon_kinematic_vectors, filename='generated_muon_kinematic_vectors.png')
