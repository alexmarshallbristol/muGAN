...
class muGAN:
    ...
    def generate_large(self, size, tuned_aux, generator_filename, batch_size=25000):
        """Generate muon kinematic vectors with normally distributed auxiliary values."""
        ...
        # with status_execution(
        # 	status_message=f"[bold green]Running generator (batch size of {batch_size})...",
        # 	complete_message="[bold green]Generation complete :white_check_mark:",
        # ):
        ...
        with Progress() as progress:
            ...
            for i in range(num_batches):
                ...
                batch_images = generator.predict(
                    [
        ...
        console.print(
            f"[grey39][{datetime.now().strftime('%H:%M:%S')}][grey39] \t{'[bold green]Generation complete :white_check_mark:'}"
        )
    ...
    def generate_custom_aux(
        self, auxiliary_distributions, size=-1, generator_filename="generator.h5"
    ):
    ...
    def generate_custom_aux_large(
        self, size, aux_gan, generator_filename="generator.h5"
    ):
        """Generate muon kinematic vectors with normally distributed auxiliary values."""
        generator = self.load_generator(generator_filename=generator_filename)
